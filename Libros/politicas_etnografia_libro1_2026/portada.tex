...
\begin{titlepage}
    \thispagestyle{empty}
    \includegraphics[width=1\textwidth]{/Users/opb/Documents/Publicaciones_UAML_DCSH/Libros/politicas_etnografia_libro1_2026/assets/imagenes/portada_lib1.png}
\end{titlepage}
...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{0.5cm}
        \small
        Coordinador: Abraham Zaíd Díaz Delgador \\
